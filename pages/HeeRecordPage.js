...
export default {
    ...
    <main class="container-fluid">
      <div class="row" style="height: 85vh;">
        ...
        <div class="col-12 col-lg-5 d-flex flex-column">
          <div class="row">
            <div class="col p-3"><h3 class="mb-2">Ē VOWEL PRACTICE</h3></div>
          </div>
          <div class="row flex-grow-1">
            <div class="col p-3 d-flex justify-content-center align-items-center">
              <!-- Updated video source for Ē vowel -->
              <video width="360" height="360" controls class="img-fluid rounded border" alt="Ē vowel articulation">
                <source src="videos/ee.mp4" type="video/mp4">
              </video>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-7 d-flex flex-column">
          <div class="row">
            <div class="col p-3">
              <!-- Updated clickable sentence for Ē vowel -->
              <p class="mb-0">
                <a href="#"
                   @click.prevent="playSample"
                   style="display:inline-block; text-decoration: underline dotted; font-weight: 600;">
                  Perfect the ē vowel using the diagram and formant plot! <i class="bi bi-play"></i>
                </a>
              </p>
            </div>
          </div>
  ...
  methods: {
    ...
    // NEW: play ē sample the same way you do for other vowels
    playSample() {
      // Expecting a sample entry under the ē key (long ē sound) for the current model speaker
      const samples = this.config.modelSpeaker?.samples?.["hē"];
      if (!samples || !samples.length) {
        console.warn("No samples found for 'ē' in the currently selected model speaker.");
        return;
      }
